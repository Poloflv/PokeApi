const bgStylePokemonType = {
    ...
    water: "bg-gradient-to-b from-[#1479FB] to-[#83B9FF]",
    bug: "bg-gradient-to-b from-[#3BB039] to-[#AAFFA8]",
    ...
    dark: "bg-gradient-to-b from-[#030706] to-[#0D1211] text-white",
    ...
    psychic: "bg-gradient-to-b from-[#E6901E] to-[#FCD676]",
    flying: "bg-gradient-to-b from-slate-400 to-slate-200",

  }   
  const borderStyledPokemonByType = {
    "grass": "border-[5px] border-green-500",
    "fire": "border-[5px] border-orange-500",
    "water": "border-[5px] border-[#1479FB]",
    ...
    "dragon": "border-[5px] border-[#478A93]",
    "fairy": "border-[5px] border-[#971B45]",
    "electric": "border-[5px] border-[#0C1395]",
    "ground": "border-[5px] border-[#654008]",
    "psychic": "border-[5px] border-[#E6901E]",
    "flying": "border-[5px] border-slate-400",
  }
